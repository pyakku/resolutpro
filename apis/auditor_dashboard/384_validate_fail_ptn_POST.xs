query validate_fail_ptn verb=POST {
  ...
  stack {
    ...
    foreach ($process_list) {
      each as $item {
        ...
        var.update $new_process_list {
          value = $new_process_list|push:$row
        }
      }
    }
    ...
    db.edit audit {
      ...
      data = {processes: $new_process_list}
    } as $audit_2
