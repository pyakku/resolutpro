query done_validations_cert verb=GET {
  ...
  stack {
    db.query required_certificates {
      where = $db.required_certificates.active == true && $db.required_certificates.p3_audited == true && $db.required_certificates.document != null && $db.required_certificates.sla_extender == 0 && $db.required_certificates.rejected != true
      return = {type: "list"}
      addon = [
        {
          name : "certificates"
