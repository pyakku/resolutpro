query validate_kpis verb=POST {
  ...
  stack {
    ...
    db.query kpi {
      ...
      where = $db.kpi.pass == false && ($db.kpi.ack_required_cert == 0 && $db.kpi.ack_other_cert == 0 || ($db.kpi.ack_required_cert == null && $db.kpi.ack_other_cert == null))
