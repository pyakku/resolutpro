query edit_certificate_archive verb=POST {
  ...
  stack {
    ...
    db.add required_certificates {
      ...
      data = {
        ...
        certificates_id        : $required_certificates_2.certificates_id
        active                 : `true`
        holder                 : $input.holder
        ...
        required_for_compliance: $required_certificates_2.required_for_compliance
        sla_extender           : $required_certificates_2.sla_extender
        user                   : $input.user
        document               : $var_1
      }
