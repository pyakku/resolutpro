function "Get Assessment Details" {
  input {
    int company_id?
  }
                        ...
                        foreach ($assessmentsV2Sections1.questionList) {
                          each as $question {
                            db.query assessmentsV2MyAssessments {
                              where = $db.assessmentsV2MyAssessments.question == $question && $db.assessmentsV2MyAssessments.checked == true && $db.assessmentsV2MyAssessments.company == $input.company_id
                              return = {type: "exists"}
                            } as $exists
